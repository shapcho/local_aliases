...
curr_p_root_folder="/home/users/kdyakov/sources/omap4/leica/"
curr_p_adb_tool="/home/users/kdyakov/.ktools/adb"
curr_p_java_path="/usr/lib/jvm/java-6-oracle/jre"
curr_p_javac_path="/usr/lib/jvm/java-6-oracle"
curr_p_set_env=""
curr_p_lunch_cmd=""
curr_p_build_specific="Yes"
curr_p_flashimgs_folder="/home/users/kdyakov/sources/omap4/leica/ducati/WTSD_DucatiMMSW/platform/base_image/out/app_m3/release"
curr_p_flash_specific="Yes"
curr_p_jpeg_folder="/home/users/kdyakov/sources/omap4/leica/images"
...
if [ $1 == fastboot_tool ]; then
	...
	if ! [ "$(ls /opt/linux_tools_for_1.22_P7/ -A )" ]; then
	...
	echo $curr_p_flash_specific
	 ...
	 rsync -auv "$curr_p_flashimgs_folder/base_image_app_m3_striped.xem3" "/media/kdyakov/New Volume/base_image_app_m3.xem3" 
         sync
